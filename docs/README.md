...
we intend to change. Work that predates `plan/` still lives in `V1.md`
at the repo root and is being moved over. Notable shipped changes are
recorded in `CHANGELOG.md`. To
