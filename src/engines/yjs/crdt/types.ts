/**
 * The selection and cursor types shared by the CRDT utilities and the
 * typed awareness. They used to live in `@wordpress/core-data`'s `types.ts`.
 */
 ...
 */
import type { SelectionType, SelectionDirection } from './crdt-user-selections';
